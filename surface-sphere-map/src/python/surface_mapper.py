...
def main(args, stdin=None, stdout=None):
    ...
    parser.add_argument('--show-accuracy',
                        type=bool,
                        default=True,
                        help="Compute and display mapping quality information [Default: %(default)s]")
    ...
    while contour.iterations < total_iterations:
        contour.run()
        if params.visualize_every is not None:
